...
export async function middleware(request: NextRequest) {
  // IMPORTANT: supabaseResponse must be returned to preserve refreshed session cookies.
  // Never return a different NextResponse object after createServerClient is called.
